...
def main(args):
    ...
    if args.resume:
        ...
        # if "expansion_stage" in checkpoint:
        #     model_without_ddp.expansion_stage = checkpoint["expansion_stage"]
    ...
    if args.eval:
        ...
        if (model_ema is not None) and ("model_ema" in checkpoint):
            ...
            print(
                f"Accuracy of the model_ema on the {len(dataset_val)} test images: {test_stats['acc1']:.2f}%"
            )
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if model_ema is not None:
            ...
            print(
                f"Accuracy of the model_ema on the {len(dataset_val)} test images: {ema_test_stats['acc1']:.2f}%"
            )
